 ...
 * [city]. Deliberately duplicated from `feature:places`'s identical type rather than shared -
 * feature modules never depend on each other directly (see CLAUDE.md).
 */
 ...
 * or found nothing) collected into one trailing group rather than dropped - same "omit
 * gracefully, don't fail" convention as a missing rating/category.
 */
