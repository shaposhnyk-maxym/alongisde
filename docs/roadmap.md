...
### M12.11 — Генералізована надійність фонової роботи: WorkManager/BGTaskScheduler-оркестратор ✅ код+тести done (iOS — no-op стаб); мануальна перевірка на пристрої — pending
